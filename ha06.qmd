...
4&2&5&0
\end{bmatrix}
\ \xrightarrow{\;R_2\gets 3R_2-2R_1,\; R_3\gets 3R_3-4R_1\;}
\begin{bmatrix}
3&6&4&8\\
0&9&-5&11\\
0&-18&-1&-32
...
0&0&-11&-10
\end{bmatrix}
\ \xrightarrow{\;R_3\gets -\tfrac{1}{11}R_3,\; R_2\gets \tfrac{1}{9}R_2\;}
\begin{bmatrix}
3&6&4&8\\
0&1&-\tfrac{5}{9}&\tfrac{11}{9}\\
0&0&1&\tfrac{10}{11}
\end{bmatrix}
\\[4pt]
&\xrightarrow{\;R_2\gets R_2+\tfrac{5}{9}R_3,\; R_1\gets R_1-4R_3\;}
\begin{bmatrix}
3&6&0&\tfrac{48}{11}\\
0&1&0&\tfrac{19}{11}\\
0&0&1&\tfrac{10}{11}
\end{bmatrix}
\ \xrightarrow{\;R_1\gets R_1-6R_2,\; R_1\gets \tfrac{1}{3}R_1\;}
\begin{bmatrix}
1&0&0&-2\\
0&1&0&\tfrac{19}{11}\\
0&0&1&\tfrac{10}{11}
...
$$
(Equivalently, the $3\times3$ left block has determinant $-33\ne 0$.)
...
$$
\boxed{(x,y,z,t,p)=\big(6,\;y,\;8-2y,\;-4,\;7+y\big),\quad y\in\mathbb{R}.}
$$
